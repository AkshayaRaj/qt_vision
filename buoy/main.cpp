...
bool redBuoyFound=false,blueBuoyFound=false,yellowBuoyFound=false;
 ...
 int main(int argc, char *argv[])
{
    ...
    int segment_id;
    const int shared_segment_size=sizeof(buoy_coords);
    buoy_coords* shared_memory;
    struct shmid_ds shmbuffer;
    int segment_size;
    segment_id=shmget(123,shared_segment_size,IPC_CREAT|S_IRUSR|S_IWUSR);
    shared_memory=(buoy_coords*)shmat(segment_id,0,0);
...
//settings:
 ...
 photo=cvLoadImage("/home/akshay/qt/second/buoy/buoysf.jpg");
          ...
          cvNamedWindow("CamOut",CV_WINDOW_AUTOSIZE);
           ...
           createCapture();
            ...
            if(settings->createCam==true)
                ...
                frame=cvLoadImage("/home/akshay/qt/second/buoy/buoysf.jpg");

                //frame=cvLoadImage("/home/akshay/qt/second/buoy/buoy2.preview.jpg");
            }

                grayScale=cvLoadImage("/home/akshay/qt/second/buoy/buoysf.jpg",CV_LOAD_IMAGE_GRAYSCALE);
            ...
            Buoy red("red",frame_resized);
            Buoy green("green",frame_resized);
            Buoy yellow("yellow",frame_resized);
          ...
          //  red.setWindowSettings();
         //   green.setWindowSettings();
        //    yellow.setWindowSettings();
            ...
            while(1){
              ...
              // frame=cvQueryFrame(cam);
               ...
               //  cvAdaptiveThreshold(L,L_adp,255,CV_ADAPTIVE_THRESH_MEAN_C,CV_THRESH_BINARY,3,cval*(-1));
                //cvInRangeS(V,cvScalar(settings->lo,0,0),cvScalar(settings->hi,0,0),L_adp);
           ...
           //     cvCanny(binary_flatten,canny,canny_t1,canny_t2);
            ...
            //Hough Circles
                ...
                //green.TrackObjects(green.imgThreshBiggestContour,&frame_resized);



                //Here we are setting the appropriate output for the processed stream according to the flip switches
         ...
         //       cvShowImage(red.threshWindow,red.imgThresh);
         //       cvShowImage(yellow.threshWindow,canny_destination);
       //         cvShowImage(green.threshWindow,green.imgThresh);
        //        cvShowImage("test",b);
            ...
            shmdt(shared_memory);
         //   cvDestroyWindow("CamOut");
         //   cvDestroyWindow("Debug_red_thresh");
         //   cvDestroyWindow("Debug_yellow_thresh");
         //   cvDestroyWindow("Debug_green_thresh");
