...
{
    QMessageBox::information(this,"SRMAUV","SRMAUV Vision Debugging Suite <Version 1.0.1> \n For any technical assitance contact Akshaya Raj Dayal");
}
