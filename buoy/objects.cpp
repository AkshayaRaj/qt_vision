...
void Buoy::setXY(int src_x,int src_y){
...
void Buoy::setHSV(int lH,int lS,int lV,int uH,int uS,int uV){
    lowerH=lH;
    lowerS=lS;
    lowerV=lV;
    upperH=uH;
...
IplImage* Buoy::GetThresholdedImage(IplImage* imageHSV){
 ...
 void Buoy::getThreshLUV(IplImage* src,IplImage* dest){
